...
## Setup
1. If you want try this sample but dont have the data to test this, you cam use this a sample file [tests/data/predictions_sample_subset_dephosphorylation.mainfest](tests/data/predictions_sample_subset_dephosphorylation.mainfest) as input data to evaluate the workflow.
